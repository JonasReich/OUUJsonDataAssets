...
public:
	...
	{
		return TEXT("/JsonData/Plugins/OUUJsonDataAssets/Tests/TestAsset_NoValuesSet");
	}

	// Get path to an asset that has all values changed compared to CDO.
	static FString GetTestPath_AllValuesSet()
	{
		return TEXT("/JsonData/Plugins/OUUJsonDataAssets/Tests/TestAsset_AllValuesSet");
	}
	...
	* #TODO-OUU Implement tests for delta serialization
	...
	{
		return TEXT("/JsonData/Plugins/OUUJsonDataAssets/Tests/TestAsset_SomeValuesSet");
	}
	*/
};
